...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/skunk-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13930&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/skunk-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `skunk` can be installed with:

```
conda install skunk
```

It is possible to list all of the versions of `skunk` available on your platform with:
